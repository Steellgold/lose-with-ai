...
import {
  ...
  IconConfetti, IconUsersGroup, IconKarate, IconJumpRope,
  IconSnowboarding, IconBallTennis, IconWood, IconWalk,
  IconStairs, IconStretching, IconTrekking, IconPingPong,
  IconGolf
...
type SPORTS = "RUNNING" | "HIIT" | "SWIMMING" | "CYCLING" |
  ...
  "SKIING" | "FUNCTIONAL" | "PILATES" | "WATER" |
  "TENNIS" | "TRX" | "ELLIPTICAL" | "STAIR" |
  "TAICHI" | "CROSSFIT" | "STAIRCLIMBING" | "PERSONAL" | "COMMUNITY";
...
export const Sports: Sport[] = [
  ...
  { id: "SWIMMING", name: "Swimming", description: "Fluid strokes in aquatic serenity.", icon: <IconSwimming className="w-6 h-6" /> },
  { id: "CYCLING", name: "Cycling", description: "Smooth pedal motion, endless vitality.", icon: <IconBike className="w-6 h-6" /> },
  { id: "CIRCUIT", name: "Circuit Training", description: "Varied exercises for holistic fitness.", icon: <IconHelmet className="w-6 h-6" /> },
  { id: "WEIGHTLIFTING", name: "Weightlifting", description: "Strengthening through controlled resistance.",
    icon: <IconBarbell className="w-9 h-9" /> },
  ...
  { id: "SKIING", name: "Skiing or Snowboarding", description: "Alpine exhilaration in winter sports.",
    icon: <IconSnowboarding className="w-6 h-6" /> },
  { id: "FUNCTIONAL", name: "Functional Training", description: "Adaptive exercises for real-world strength.",
    icon: <IconTrekking className="w-6 h-6" /> },
  { id: "PILATES", name: "Pilates", description: "Core-centric balance and flexibility.", icon: <IconGolf className="w-6 h-6" /> },
  { id: "WATER", name: "Water Sports", description: "Kayaking - aquatic adventure and fitness fusion.", icon: <IconPool className="w-6 h-6" /> },
  ...
  { id: "ELLIPTICAL", name: "Elliptical Cycling", description: "Fluid elliptical motion for low-impact cardio.",
